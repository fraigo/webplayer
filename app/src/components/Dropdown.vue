<template>
    <div class="relative inline-block text-left">
      ...
      <!-- Dropdown menu -->
      <div v-if="isOpen" class="dropdown-options text-white origin-top-right absolute right-0 mt-0 rounded-md shadow-lg bg-blue-700 ring-1 ring-black ring-opacity-5 focus:outline-none z-20" role="menu">
        <div
